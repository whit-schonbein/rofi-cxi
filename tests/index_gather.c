...
int main(int argc, char *argv[]) {
    ...
    if (0 == me) {
      ...
      printf("#   local_table_size    :   %d\n", args.local_table_size);
      printf("#   global_table_size   :   %d\n", args.global_table_size);
      printf("#   local_num_gathers   :   %d\n", args.local_num_gathers);
      printf("#   global_num_gathers  :   %d\n", args.global_num_gathers);
      printf("#   seed                :   %d\n", args.seed);
    }
    ...
    if (0 == me) {
      printf("# Adjusted run parameters:\n");
      printf("#   local_table_size    :   %d\n", args.local_table_size);
      printf("#   global_table_size   :   %d\n", args.global_table_size);
      printf("#   local_num_gathers   :   %d\n", args.local_num_gathers);
      printf("#   global_num_gathers  :   %d\n", args.global_num_gathers);
